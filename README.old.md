...
- [Estrutura do SDK](#️-estrutura-do-sdk)
...
- [Tratamento de Erros](#%EF%B8%8F-tratamento-de-erros)
...
- [Swagger da API](./swagger.json) - Especificação OpenAPI local
- Consulte a documentação oficial da API TinyERP V3 para informações completas sobre endpoints e parâmetros
